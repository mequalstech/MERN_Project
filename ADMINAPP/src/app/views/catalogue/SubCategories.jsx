...
const SubCategories = () => {
    ...
    let sortableColumn = [
        ...
        },
        {
            ...
            formatter: (cell, row, index) => {
                // className="zoom"
                return <img class={row.filename?'':'alt-css'}  style={{ width: '50px', height: '50px' }} src={row.filename?row.filename:common.addDefaultSrc} alt="Image Not Added" />;
            },
            classes: 'text-center',
            editable: false,
            sort: false
    ...
    const handleSubmit = (values, { setSubmitting }) => {
        ...
        if (values._id !== '') {
            ...
            imageUrl?fd.append('filename', imageUrl):fd.append('filename','');
            ...
            axios
                ...
                .catch((err) => {NotificationManager.warning(
                    err.message
                );
                    console.log(err);
                })
    ...
    return (
        <div>
            <Breadcrumb
                routeSegments={[
                    // { name: "Dashboard", path: "/" },
                    { name: "Catalog", path: rootPath + "catalogue/subcategories" },
                    { name: "Sub Category" }
                ]}
            />
                        ...
                        return (
                            ...
                            >
                                ...
                                <Modal.Body>
                                    ...
                                    <FormLabel className="font-weight-bold">Sub Category Name<span class="m-1 text-danger">*</span></FormLabel>
                                        <FormControl
                                            type="text"
                                            className={errors.subcategory ? "form-control col-md-12 is-invalid" : "form-control col-md-12"}
                                            name='subcategory'
                                    ...
                                    <div className='col-md-12 mb-3 pl-0 form-group'>
                                        ...
                                        >
                                            <span class="removeicon"    
                                                style={{ display: (showBtn || (values.filename !== undefined)) ? 'block' : 'none',top:'-6px',right:'6px', marginTop: '0px !important' }}
                                                onClick={() => {
                                                    setShowBtn(false)
                                                    setFiles([])
                                                    setImageUrl('')
