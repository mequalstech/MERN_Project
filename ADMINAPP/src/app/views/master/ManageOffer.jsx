    ...
    return (
        <>
            <Breadcrumb
                ...
                routeSegments={[
                    { name: "Master", path: rootPath + "master/discounts-offer" },
                    { name: "Manage Offer" }
                ]}
            ></Breadcrumb>
            <SimpleCard title={
                ...
                <Form className="px-3 needs-validation">
                    ...
                    <Modal.Body>
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <img onError={common.addDefaultSrc}  src={(offerData.length > 0) ? 
                                (offerData[0].image ?  offerData[0].image : process.env.PUBLIC_URL + "/placeholder.png") :
                                 process.env.PUBLIC_URL + "/placeholder.png"} alt="" style={{
                                    width: '100%',
                                    objectFit: 'contain',
                                    height: '183px'
                                }} />
