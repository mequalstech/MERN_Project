        ...
        if (err) {
            ...
            if (data.length != 0) {
                ...
                if (data) {
                    ...
                    let categoryData = await Category.find({ status: 1, category: key }, { createdon: 0, updatedon: 0, __v: 0 });
                    let subcategoryData = await SubCategory.find({ status: 1, subcategory: key }, { createdon: 0, updatedon: 0, __v: 0 });
